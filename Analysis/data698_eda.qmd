...
```{python}
dqr_url = 'https://raw.githubusercontent.com/eddiexunyc/capstone_work_project/refs/heads/main/Resources/Data/summary_metric_quantile_revised_mono.csv'
...
# create the table plot and position it in the upper left corner
table(plot, dqr_metric,loc='center')

# save the plot as a png file
plt.savefig('../Resources/Results/dqr_metric_revised_mono.png', dpi = 300)
```