...
To assess and evaluate the predictive performance for all regression models, various metrics were used. This approach provided a comprehensive evaluation of both point prediction accuracy and uncertainty estimation. The following metrics for traditional regressions are defined below:
...
The Deep Quantile Regression was trained and evaluated as well. Here is the result from the evaluation metric:

![Evaluation of Deep Quantile Regression]

### Models Comparsion

There is no direct comparsion between traditional and Deep Quantile regressions. 
